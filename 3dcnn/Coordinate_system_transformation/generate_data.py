...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 23 16:45:45 2021
...
#change one point from cartesian to polar
...
#change one point from polar to cartesian
...
#transfrom all volumes from cartesian to polar
        ...
        for r in range(new_image.shape[0]):
            for theta in range(new_image.shape[1]):
                for phi in range(new_image.shape[2]):
                    ...
                    #comment/uncomment to use different interpolations
...
#transfrom all volumes from polar to cartesian
